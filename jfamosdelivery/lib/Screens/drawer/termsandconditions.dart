...
class _TermsState extends State<Terms> {
  var api =
      'http://www.jfamoslogistics.com/APIs/APIs2.asmx/Forms?ftype=terms and conditions';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: const [
            ListTile(
              ...
              subtitle: Text(
                '''Eiusmod laborum dolore incididunt cillum. Velit quis magna ea mollit amet do adipisicing qui. Officia minim nulla exercitation excepteur consectetur. Excepteur amet consectetur laboris fugiat laborum pariatur ipsum minim nisi qui.
        ...
        Qui eiusmod ea veniam dolore. Id nisi laborum dolore dolor reprehenderit ut cupidatat irure quis. Ut consectetur tempor eiusmod pariatur ut anim sint voluptate exercitation adipisicing cupidatat. Esse laboris exercitation incididunt cupidatat eu nostrud velit est. ''',
            ...
            ListTile(
              ...
              subtitle: Text(
                  '''Cupidatat fugiat dolore aliquip ea veniam ex consectetur enim laborum ex. Eu nisi ad et cupidatat aliqua Lorem aute do proident esse excepteur tempor ea. Magna consectetur culpa enim ullamco elit anim Lorem enim proident qui eu quis aliquip. Labore occaecat pariatur duis non magna non commodo nulla excepteur dolor.
