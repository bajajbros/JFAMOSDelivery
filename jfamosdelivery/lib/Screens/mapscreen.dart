...
import 'package:jfamosdelivery/helper/location.dart';
...
class _MapScreenState extends State<MapScreen> {
  ...
  void _gotoDefault() async {
    double lat = await Location().getLatitude();
    double lng = await Location().getLongitude();
    ...
    return Scaffold(
      body: MapLayoutBuilder(
        ...
        builder: (context, transformer) {
          ...
          // final homeLocation = transformer.fromLatLngToXYCoords(LatLng(Future.value(), 19));
